...
# NOTE: This combination assumes that the vector components of the vector generated by
# the saliency_to_pose node is within the camera frame of reference. As such, it's important to 
# keep the camera gravity alligned, otherwise things will get out of wack pretty quickly. 
